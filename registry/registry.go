...
func init() {
	...
	errs.Add(
		...
		const.ActionRegistry.Register(&actions.CreateAsset{}, actions.UnmarshalCreateAsset, false),
		const.ActionRegistry.Register(&actions.MintAsset{}, actions.UnmarshalMintAsset, false),
